...
---
<div class="pattern-footer-nav"><a class="nav-prev" href="../llm-as-wizard-of-oz/">← LLM as Wizard of Oz</a><a class="nav-next" href="../llm-checking-llm/">LLM-Checking-LLM →</a></div>
