...
---
<div class="pattern-footer-nav"><a class="nav-prev" href="../hot-path-result-caching/">← Hot-Path Result Caching</a><a class="nav-next" href="../multiplexed-dispatch/">Multiplexed Dispatch →</a></div>
