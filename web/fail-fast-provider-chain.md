...
---
<div class="pattern-footer-nav"><a class="nav-prev" href="../hot-path-result-caching/">← Hot-Path Result Caching</a><a class="nav-next" href="../rent-then-build/">Rent, Then Build →</a></div>
