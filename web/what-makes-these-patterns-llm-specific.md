...
* **A rapidly evolving, vendor-controlled substrate**: models and prompts improve and are deprecated on the vendor's schedule, underneath long-lived data (drives [LLM Output Provenance](../llm-output-provenance/)).
