...
---
<div class="pattern-footer-nav"><a class="nav-prev" href="../deterministic-postprocessing/">← Deterministic Postprocessing</a><a class="nav-next" href="../prompt-injection-containment/">Prompt Injection Containment →</a></div>
