...
---
<div class="pattern-footer-nav"><a class="nav-prev" href="../targeted-user-feedback/">← Targeted User Feedback</a><a class="nav-next" href="../prompt-injection-containment/">Prompt Injection Containment →</a></div>
